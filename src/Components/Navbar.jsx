  ...
  return (
    ...
    >
      <div className="flex items-center h-full justify-between">
        {/* Logo - left corner */}
        <a href="#home" className="ml-[30px]" onClick={() => setIsOpen(false)}>
          <img
            src={Logo}
            alt="Logo"
        ...
        {/* Desktop Links - right corner */}
        <ul className="hidden md:flex list-none gap-10 mr-[30px]">
          {links.map((link) => (
            <li key={link.name} className="relative group">
              ...
              {/* Cool gradient glow effect on hover */}
        ...
        {/* Hamburger - mobile */}
        <div
          className="flex flex-col gap-2 cursor-pointer md:hidden mr-[30px] z-50"
      ...
      {/* Mobile Menu */}
      <ul
        className={`fixed inset-0 flex flex-col justify-center items-center gap-10 bg-[rgba(20,24,36,0.97)] backdrop-blur-[18px] transition-transform duration-300 md:hidden ${
