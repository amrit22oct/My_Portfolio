...
const Services = () => {
  return (
    ...
    >
      {/* Section Title */}
      <h1 className="text-[2.8rem] font-bold mb-12 pl-[18px] inline-block border-l-[6px] border-white-400 text-left drop-shadow-[0_0_15px_#00e0ff] relative z-[1]
        md:text-[2.4rem] sm:text-[2rem] sm:mb-10">
        My Services
      </h1>

      {/* Services Grid */}
      <div
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[35px] justify-items-center  mt-20 items-stretch relative z-[1]"
      >
        {services.map((service, index) => (
          <motion.div
            key={index}
            className="group bg-[rgba(20,20,20,0.9)] p-[35px_25px] rounded-[18px] border border-[rgba(0,224,255,0.25)] shadow-[0_0_15px_rgba(0,224,255,0.1)] text-center transition-all duration-300 ease-in-out hover:-translate-y-2 hover:scale-105 hover:border-[#ff4fff] hover:shadow-[0_0_25px_#ff4fff,0_0_50px_rgba(255,79,255,0.6)]"
          ...
          >
            {/* Icon */}
            <div className="text-[3.2rem] text-[#00ff90] mb-[18px] flex justify-center items-center transition-all duration-300 ease-in-out group-hover:text-[#00e0ff] group-hover:drop-shadow-[0_0_18px_#00e0ff,0_0_35px_rgba(0,224,255,0.6)]">
              {service.icon}
            </div>
