...
const Contacts = () => {
  return (
    ...
    >
      {/* Section Title */}
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold italic mb-12 pl-4 border-l-6 border-white-400 drop-shadow-[0_0_15px_#00e0ff] text-center sm:text-left">
        Let's Connect
      </h1>

      {/* Container */}
      <div className="flex flex-col md:flex-row flex-wrap gap-8 w-full  mt-15 max-w-[1200px] justify-center items-stretch">
        ...
        <div className="flex-1 w-full max-w-[500px] min-h-[500px] bg-[rgba(20,20,20,0.9)] p-6 rounded-2xl shadow-[0_0_15px_rgba(0,224,255,0.4)] backdrop-blur-md transition-transform duration-500 hover:-translate-y-2 hover:shadow-[0_0_25px_rgba(0,224,255,0.7)] flex flex-col justify-between">
          <div>
            ...
            <p className="text-[#d4d4d4] mb-6 leading-relaxed text-sm sm:text-base italic">
              Full Stack Developer skilled in the MERN stack. I craft modern,
              interactive, and intuitive applications that solve real-world
              problems. Passionate about clean code, continuous learning, and
